...
if sect == "Homepage":
	...
	prices = ["20", "30", "160", "120", "150", "30", "60", "1500", "1000"]
	...
	if product == "+1 Speaker at Your Next Party" or product == "LyxPro SPA-10 10\" Portable Professional PA Speaker (Standalone)":
		st.markdown(f'<h3 style="color:\'0055FF\';font-size:20px;">{product} - {prices[[i.index for i in products if i == product]]}</h3>', unsafe_allow_html=True)
